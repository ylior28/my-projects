...
•	Locomotion – Four DC gear motors driven by an L293D motor driver, providing stable and fast navigation.

•	 Obstacle Avoidance – Ultrasonic SRF-04 sensors for real-time distance measurement and path correction.

•	 Bluetooth Control – HC-06 module for vehicle activation and stop commands. 


This project provided practical experience in embedded system integration, sensor fusion, and autonomous navigation algorithms, as well as hardware/software co-design and troubleshooting in real-world conditions.
